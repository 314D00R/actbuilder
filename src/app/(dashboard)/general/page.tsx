		...
		useActStore.setState(state => {
			const nextId =
				state.owners.length > 0
					? Math.max(...state.owners.map(o => o.id)) + 1
					: 1
			return {
				owners: [
					...state.owners,
			...
			<Card className='border-l-4 border-l-primary bg-card/60 backdrop-blur-sm shadow-md'>
				...
				<CardContent className='space-y-4'>
					{owners.map((owner, index) => (
						<div
							key={owner.id}
							className='p-4 bg-secondary/30 border border-border rounded-xl space-y-4'
						>
							...
							<div className='space-y-2'>
								...
								<Input
									...
									value={owner.name}
									onChange={e =>
										updateOwnerField(owner.id, 'name', e.target.value)
									}
									className='w-full'
								/>
							</div>
							...
							<div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
								<div className='space-y-2'>
									...
									<Input
										...
										value={owner.doc}
										onChange={e =>
											updateOwnerField(owner.id, 'doc', e.target.value)
										}
										className='w-full'
									/>
								</div>
								<div className='space-y-2 md:col-span-2'>
									...
									<Input
										...
										value={owner.org}
										onChange={e =>
											updateOwnerField(owner.id, 'org', e.target.value)
										}
										className='w-full'
									/>
								</div>
								<div className='space-y-2'>
									...
									<Input
										...
										onChange={e =>
											updateOwnerField(owner.id, 'pass_date', e.target.value)
										}
										className='w-full'
									/>
								</div>
			...
			<Card className='bg-card/60 backdrop-blur-sm shadow-md'>
				...
				<CardContent className='grid grid-cols-1 md:grid-cols-3 gap-4'>
					<div className='space-y-2 w-full'>
						...
						<Select
							value={inputs.q_1 || 'ні'}
							onValueChange={val => setInputValue('q_1', val)}
						>
							<SelectTrigger className='w-full bg-background'>
								<SelectValue />
							</SelectTrigger>
					...
					<div className='space-y-2 w-full'>
						...
						<Select
							value={inputs.q_2 || 'ні'}
							onValueChange={val => setInputValue('q_2', val)}
						>
							<SelectTrigger className='w-full bg-background'>
								<SelectValue />
							</SelectTrigger>
					...
					<div className='space-y-2 w-full'>
						...
						<Select
							value={inputs.q_3 || 'ні'}
							onValueChange={val => setInputValue('q_3', val)}
						>
							<SelectTrigger className='w-full bg-background'>
								<SelectValue />
							</SelectTrigger>
