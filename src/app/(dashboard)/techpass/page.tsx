...
import { Building, Plus, Ruler, Trash2 } from 'lucide-react'
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
						<div className='space-y-2 md:col-span-1'>
							...
							<Input
								type='text'
								value={
									inputs.heritage_info !== undefined
										? inputs.heritage_info
										: 'відсутні'
								}
					...
					<div className='grid grid-cols-2 md:grid-cols-7 gap-4'>
						<div className='space-y-2 md:col-span-2'>
							...
							<Input
								type='text'
								value={
									inputs.floors_total !== undefined ? inputs.floors_total : '1'
								}
						...
						<div className='space-y-2'>
							...
							<Input
								type='text'
								value={
									inputs.mansard !== undefined ? inputs.mansard : 'відсутні'
								}
						...
						<div className='space-y-2'>
							...
							<Input
								type='text'
								value={
									inputs.sections !== undefined ? inputs.sections : 'відсутні'
								}
					...
					<div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
						...
						<div className='space-y-2'>
							...
							<Input
								type='text'
								value={
									inputs.built_in_area !== undefined
										? inputs.built_in_area
										: '0'
								}
				...
				<CardHeader className='pb-4'>
					<CardTitle className='text-sm font-bold flex items-center gap-2'>
						<Building
							...
							className='text-primary'
						/>{' '}
						Конструктивні елементи (по будівлях / літерах)
					</CardTitle>
				</CardHeader>
							...
							<div className='flex items-center justify-between border-b border-border/60 pb-3'>
								<div className='flex items-center gap-3 w-full max-w-sm'>
									...
									<Input
										...
										value={bld.name || ''}
										onChange={e =>
											handleUpdateBuilding(bld.id, 'name', e.target.value)
										}
									/>
								</div>
								{buildings.length > 1 && (
